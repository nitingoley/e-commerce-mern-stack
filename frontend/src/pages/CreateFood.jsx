  ...
  return (
    <div className='p-6 bg-gray-50 min-h-screen flex justify-center '>
        ...
        <div className='container max-w-lg shadow-lg rounded-lg p-5 bg-white'>
            ...
            <h1 className='text-3xl font-semibold text-gray-800 my-4'>Upload product</h1>
            <div className='space-y-4'>
                <label htmlFor='name' className='block text-lg text-gray-600 mb-2'>product name</label>
                <input
                id="name"
                type="text"
                value={name}
                ...
                <label htmlFor='priceInCents' className='block text-lg text-gray-600 mb-2'>Dollars</label>
                <input
                id="priceInCents"
                type="number"
                value={priceInCents}
                ...
                <button onClick={handleSaveFood} className='w-full bg-red-500 hover:bg-red-800 text-white py-2 px-4 rounded-md' >Save</button>
            </div>
        </div>
    </div>
  )
